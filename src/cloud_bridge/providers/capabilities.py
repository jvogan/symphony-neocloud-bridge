    ...
    return {
        ...
        "resources": {
            ...
            "runtime_metrics": {
                ...
                "bridge_commands": ["runtime-metrics", "progress-report", "productivity-plan"],
                "fields": [
            ...
            "gpu_catalog": {
                "surface": "RunPod GraphQL gpuTypes",
                "bridge_commands": ["gpu-catalog"],
                "notes": [
                    "use before retrying REST create on GPU 'no instances' responses",
                    "distinguishes GPU/DC catalog mismatch from capacity-zero for requested gpuTypeIds and dataCenterIds",
                    "does not prove capacity on the network-volume-attached machine subset",
                ],
            },
        ...
        "limitations": [
            ...
            "Flash and generic Serverless endpoint lifecycle are documented opportunities; they do not have guarded launch support in this bridge yet",
            "Instant Clusters are a watchlist target and do not have guarded launch support in this bridge",
            "scoped RunPod API keys should be used when available, but programmatic per-run key provisioning is not part of this bridge",
            ...
            "provider-side cost-center assignment is recorded as intended manifest metadata until a safe machine-readable assignment route has automated launch support",
